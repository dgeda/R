...
### Use graphics to check the contents in the usertpe column
...
all_2019 %>%
  ...
  summarise(number_of_rides = n(),average_duration = mean(tripduration)) %>% #calculates number of rides and avg duration 
